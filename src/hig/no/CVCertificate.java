...
/**
 * Encapsulation class for a card verifiable certificate according to ICAO.
 * We assume there is only one instance of this class for the current EAC
...
public class CVCertificate {
     ...
     * parse the signature (we have chosen not to provide it).
     * 
     * @param in
